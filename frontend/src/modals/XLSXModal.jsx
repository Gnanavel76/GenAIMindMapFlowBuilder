...
const XLSXModal = () => {
	...
	const addDataSource = (e) => {
		...
		const [url, body, headerConfig] = setRequestData("xlsx", flowId, data);
		...
		<div className="modal-container">
			...
			<div className="data-source-input">
				<label htmlFor="filesUp" className="data-source-set" >
					<div>
						<img src={XLSXSvg} alt="image will be here"/>
						{/* <p>Upload a CSV</p> */}
						{file ? <p>{file.name}</p> : <p>Upload a XLSX</p>}
					</div>
					<img src={RIGHTArrow} alt={"RIght arrow"} />
				</label>
				<input id="filesUp" type="file" accept={xlsxAccept} style={{ "display": "none" }} onChange={(e) => handleFileUpload(e)} />
			</div>
